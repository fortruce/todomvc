(defproject todomvc "0.1.0-SNAPSHOT"
  ...
  :ring {:handler todomvc.handler/app
         :uberwar-name "todomvc.war"}
  ...
  :profiles {:dev {:repl-options {:init-ns todomvc.handler
             ...
             :production {:ring {:open-browser? false
                                 :stacktraces?  false
                                 :auto-reload?  false}
                          :cljsbuild {:builds {:app {:compiler {:main "todomvc.prod"}}}}
                          }})
